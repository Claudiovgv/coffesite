...
return [
  ...
  'meta.product.description'    => 'Découvrez notre origine %s. Café premium torréfié au Portugal.',
  'product.back'                => '← Nos Cafés',
  'product.single.origin'       => 'Origine Unique',
  'product.arabica'             => '100% Arabica',
  'product.origin.label'        => 'Origine',
  'product.roast.label'         => 'Torréfaction',
  'product.process.label'       => 'Procédé',
  'product.variety.label'       => 'Variété',
  'product.formats.title'       => 'Formats Disponibles',
  'product.format.250.weight'   => '250g',
  'product.format.250.desc'     => 'Idéal pour la dégustation ou usage domestique.',
  'product.format.1kg.weight'   => '1kg',
  'product.format.1kg.desc'     => 'Parfait pour les hôtels et restaurants.',
  'product.order.title'         => 'Demander un Devis',
  'product.order.desc'          => 'Intéressé par cette origine ? Remplissez vos coordonnées et nous préparerons une proposition personnalisée.',
  'product.order.coffee.label'  => 'Origine',
  'product.order.size.label'    => 'Format',
  'product.order.size.250'      => '250g',
  'product.order.size.1kg'      => '1kg',
  'product.order.qty.label'     => 'Quantité',
  'product.order.qty.ph'        => 'ex : 10 unités',
  'product.order.name.label'    => 'Nom *',
  'product.order.name.ph'       => 'Votre nom',
  'product.order.email.label'   => 'Email *',
  'product.order.email.ph'      => 'email@entreprise.com',
  'product.order.phone.label'   => 'Téléphone',
  'product.order.phone.ph'      => '+351 900 000 000',
  'product.order.notes.label'   => 'Notes',
  'product.order.notes.ph'      => 'Détails de livraison, exigences spéciales...',
  'product.order.submit'        => 'Envoyer la Demande',
  'form.order.error'            => 'Veuillez remplir votre nom, email et quantité.',
  'form.order.success'          => 'Demande envoyée ! Nous préparerons votre proposition sous peu.',
  'form.order.sending'          => 'Envoi...',
  /* Banner */
