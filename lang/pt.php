...
return [
  ...
  /* Product pages */
  'meta.product.title'          => '%s — Atlantic Crown Coffee',
  'meta.product.description'    => 'Descubra a nossa origem %s. Café premium torrado em Portugal.',
  'product.back'                => '← Os Nossos Cafés',
  'product.single.origin'       => 'Origem Única',
  'product.arabica'             => '100% Arábica',
  'product.origin.label'        => 'Origem',
  'product.roast.label'         => 'Torrefação',
  'product.process.label'       => 'Processo',
  'product.variety.label'       => 'Variedade',
  'product.formats.title'       => 'Formatos Disponíveis',
  'product.format.250.weight'   => '250g',
  'product.format.250.desc'     => 'Ideal para prova ou uso doméstico.',
  'product.format.1kg.weight'   => '1kg',
  'product.format.1kg.desc'     => 'Perfeito para hotéis e restaurantes.',
  'product.order.title'         => 'Solicitar Orçamento',
  'product.order.desc'          => 'Interessado nesta origem? Preencha os seus dados e preparamos uma proposta personalizada.',
  'product.order.coffee.label'  => 'Origem',
  'product.order.size.label'    => 'Formato',
  'product.order.size.250'      => '250g',
  'product.order.size.1kg'      => '1kg',
  'product.order.qty.label'     => 'Quantidade',
  'product.order.qty.ph'        => 'ex: 10 unidades',
  'product.order.name.label'    => 'Nome *',
  'product.order.name.ph'       => 'O seu nome',
  'product.order.email.label'   => 'Email *',
  'product.order.email.ph'      => 'email@empresa.com',
  'product.order.phone.label'   => 'Telefone',
  'product.order.phone.ph'      => '+351 900 000 000',
  'product.order.notes.label'   => 'Notas',
  'product.order.notes.ph'      => 'Detalhes de entrega, requisitos especiais...',
  'product.order.submit'        => 'Enviar Pedido',
  'form.order.error'            => 'Por favor preencha o nome, email e quantidade.',
  'form.order.success'          => 'Pedido enviado! Preparamos a sua proposta brevemente.',
  'form.order.sending'          => 'A enviar...',
  /* Banner */
