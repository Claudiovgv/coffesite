...
return [
  ...
  'meta.product.description'    => 'Discover our %s single origin. Premium coffee roasted in Portugal.',
  'product.back'                => '← Our Coffees',
  'product.single.origin'       => 'Single Origin',
  'product.arabica'             => '100% Arabica',
  'product.origin.label'        => 'Origin',
  'product.roast.label'         => 'Roast',
  'product.process.label'       => 'Process',
  'product.variety.label'       => 'Variety',
  'product.formats.title'       => 'Available Formats',
  'product.format.250.weight'   => '250g',
  'product.format.250.desc'     => 'Ideal for tasting or home use.',
  'product.format.1kg.weight'   => '1kg',
  'product.format.1kg.desc'     => 'Perfect for hotels and restaurants.',
  'product.order.title'         => 'Request a Quote',
  'product.order.desc'          => 'Interested in this origin? Fill in your details and we will prepare a personalised proposal.',
  'product.order.coffee.label'  => 'Origin',
  'product.order.size.label'    => 'Format',
  'product.order.size.250'      => '250g',
  'product.order.size.1kg'      => '1kg',
  'product.order.qty.label'     => 'Quantity',
  'product.order.qty.ph'        => 'e.g. 10 units',
  'product.order.name.label'    => 'Name *',
  'product.order.name.ph'       => 'Your name',
  'product.order.email.label'   => 'Email *',
  'product.order.email.ph'      => 'email@company.com',
  'product.order.phone.label'   => 'Phone',
  'product.order.phone.ph'      => '+351 900 000 000',
  'product.order.notes.label'   => 'Notes',
  'product.order.notes.ph'      => 'Delivery details, special requirements...',
  'product.order.submit'        => 'Send Request',
  'form.order.error'            => 'Please fill in your name, email and quantity.',
  'form.order.success'          => 'Request sent! We will prepare your proposal shortly.',
  'form.order.sending'          => 'Sending...',
  /* Banner */
